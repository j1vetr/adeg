    ...
    <section id="contact" className="py-24 bg-background relative border-t border-white/5">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-primary font-bold tracking-[0.2em] mb-2 uppercase">Get In Touch</h2>
          <h3 className="text-3xl md:text-4xl font-bold text-white font-display">Contact Us</h3>
        </div>
