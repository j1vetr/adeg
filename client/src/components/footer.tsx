    ...
    <footer className="bg-black relative pt-16 pb-8 overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-start gap-12 mb-16">
          ...
          <div className="max-w-md">
             ...
             <p className="text-gray-400 leading-relaxed text-sm">
               Denizcilik sektöründe kesintisiz iletişim ve siber güvenlik çözümleri. 
               Dünyanın her noktasında yanınızdayız.
             </p>
          </div>
          ...
          <div className="grid gap-6">
            <div className="flex items-start gap-4 group">
              ...
              <div>
                <h4 className="text-white font-bold text-sm mb-1">Adres</h4>
            ...
            <div className="flex items-start gap-4 group">
              ...
              <div>
                <h4 className="text-white font-bold text-sm mb-1">E-posta</h4>
            ...
            <div className="flex items-start gap-4 group">
              ...
              <div>
                <h4 className="text-white font-bold text-sm mb-1">Telefon</h4>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-xs md:text-sm text-gray-500">
          <div>
            &copy; {new Date().getFullYear()} AdeGloba. Tüm Hakları Saklıdır. <span className="mx-2 text-primary">|</span> Bu Website <a href="https://toov.com.tr" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-primary transition-colors font-semibold">TOOV</a> tarafından hazırlanmıştır.
          </div>
